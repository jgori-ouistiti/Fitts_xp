...
def readFileExperiment(filename, width, height):
    ...
    for line in lines:
        if line.startswith("pause"):
            ...
            listTimePause.append((nbExperience-1, timePause))

        else:
            nbExperience += 1
            print(" -- En cours de generer la ", nbExperience, "-eme game expérience")
    ...
    f.close()
    return GameExperiment(WIDTH, HEIGHT, list_experiences, listTimePause)